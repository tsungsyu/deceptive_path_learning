# deceptiveGridWorld.py
# ------------
# This file is a modified version of the gridworld.py file written for
...
def runEpisode(agent, environment, discount, decision, display, message, pause, episode, goalMode):
    returns = 0
    totalDiscount = 1.0
    environment.reset()
...
def parseOptions():
    ...
    optParser.add_option('-e', '--epsilon1', action='store',
                         type='float', dest='epsilon1', default=0.5,
                         metavar="E", help='Chance of taking a random action in q-learning training phase (default %default)')
    ...
    optParser.add_option('-g', '--grid', action='store',
                         metavar="G", type='string', dest='grid', default="EvaluationGrid15"
                                                                          ""
                                                                          "",
    ...
    optParser.add_option('-o', '--phaseOneEpisodes', action='store', type='int', dest='phaseOneEpisodes', default=600,
                         help='Number of training games in phase one')
    optParser.add_option('-x', '--phaseTwoEpisodes', action='store', type='int', dest='phaseTwoEpisodes', default=20,
                         help='Number of training games in phase two')
    optParser.add_option('-y', '--displayEpisodes', action='store', type='int', dest='displayEpisodes', default=10,
                         help='Number of post-training games displayed')
    optParser.add_option('-f', '--epsilon2', action='store',
                         type='float', dest='epsilon2', default=1.0,
                         metavar="E", help='Chance of taking a random action in second phase of q-learning (default %default)')
...
if __name__ == '__main__':
    ...
    import deceptiveGridWorld

    mdpFunction = getattr(deceptiveGridWorld, "get" + opts.grid)
    mdp = mdpFunction()
    mdp.setLivingReward(opts.livingReward)
    mdp.setNoise(opts.noise)
    env = deceptiveGridWorld.GridworldEnvironment(mdp)
    ...
    import valueIterationAgents, deceptiveQLearningAgents

    a = None

    episodes = opts.phaseOneEpisodes + opts.phaseTwoEpisodes + opts.displayEpisodes
    numTraining = opts.phaseOneEpisodes + opts.phaseTwoEpisodes

    if opts.agent == 'value':
        a = valueIterationAgents.ValueIterationAgent(mdp, opts.discount, opts.iters)
    elif opts.agent == 'q':
        # env.getPossibleActions, opts.discount, opts.learningRate, opts.epsilon1
        ...
        qLearnOpts = {'gamma': opts.discount,
                      ...
                      'actionFn': actionFn,
                      'phaseOneEpisodes': opts.phaseOneEpisodes,
                      'phaseTwoEpisodes': opts.phaseTwoEpisodes,
                      'epsilon2': opts.epsilon2}
        print "**qLearnOpts: ", qLearnOpts
        a = deceptiveQLearningAgents.QLearningAgent(**qLearnOpts)
    ...
    for episode in range(1, episodes + 1):
        ...
        beQuiet = episode < (a.phaseOneEpisodes + a.phaseTwoEpisodes)
